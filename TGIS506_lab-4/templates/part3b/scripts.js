...
window.onload = function() {
  ...
  var nbaRev = [2.66,2.72,2.93,3.19,3.37,3.57,3.77,3.79,3.81,3.96,3.68,4.56,4.79,5.18,5.87,7.37,8.01,8.76, 0];
  var nhlRev = [1.875,1.996,2.083,,2.178,2.44,2.75,2.82,2.93,3.09,3.37,2.63,3.7,3.98,4.1,4.43,4.86,5.09, 0];
  var mlbRev = [3.62,3.88,4.27,4.73,5.11,5.48,5.82,5.9,6.14,6.36,6.81,7.1,7.86,8.39,9.03,9.46,9.9,10.37, 0];
